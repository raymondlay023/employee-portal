<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-extrabold text-xl text-slate-900 leading-tight tracking-tight">Edit Leave Request</h2>
            <p class="text-xs text-slate-400 font-medium mt-0.5">Modify your pending leave request details below</p>
        </div>
    </x-slot>
