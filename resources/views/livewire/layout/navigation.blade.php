...
<div>
            ...
            <div x-show="sidebarOpen" @click.away="sidebarOpen = false" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4 shadow-xl">
                ...
                <div class="mt-8 h-0 flex-1 overflow-y-auto">
                    <nav class="space-y-1 px-2">
                        <!-- Mobile Links -->
                        <a href="{{ route('dashboard') }}" wire:navigate class="{{ request()->routeIs('dashboard') ? 'bg-brand-50 text-brand-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-base font-medium rounded-md transition-colors">
                        ...
                        <a href="{{ route('employees.index') }}" wire:navigate class="{{ request()->routeIs('employees.*') ? 'bg-brand-50 text-brand-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-base font-medium rounded-md transition-colors">
                        ...
                        <a href="{{ route('attendance.index') }}" wire:navigate class="{{ request()->routeIs('attendance.*') ? 'bg-brand-50 text-brand-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-base font-medium rounded-md transition-colors">
                        ...
                        <a href="{{ route('leave-requests.index') }}" wire:navigate class="{{ request()->routeIs('leave-requests.*') ? 'bg-brand-50 text-brand-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-base font-medium rounded-md transition-colors">
    ...
    <div class="hidden md:flex md:flex-shrink-0 md:w-64 bg-white border-r border-gray-200 z-10 shadow-sm relative">
